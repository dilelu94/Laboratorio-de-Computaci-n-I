...
float promedioVector(int v[], int tam); /// devuelve el promedio de los valores del vector

float promedio(float suma, int tam); /// devuelve el promedio de los valores en base al tamaño
